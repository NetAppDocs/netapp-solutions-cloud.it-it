...
* Utilizza un Helm chart per installare Trident sui cluster OSD. Consulta link:https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy-helm.html["Qui"] per le istruzioni su come installare l'Helm chart.
