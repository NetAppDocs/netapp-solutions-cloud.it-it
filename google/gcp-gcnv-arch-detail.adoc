...
La figura seguente, a cui si fa riferimento dal https://cloud.google.com/architecture/partners/netapp-cloud-volumes/architecture?hl=en_US["sezione architettura"^] della documentazione Google Cloud NetApp Volumes , mostra una vista di alto livello.
